...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.lb_gridpasswordview, this);
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.lb_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.lb_textview, null);
