...
public class FormCommodityAdapter extends BaseQuickAdapter<CommodityEntity, BaseViewHolder> {

    private int diameter;

    public FormCommodityAdapter(int layoutResId, @Nullable List<CommodityEntity> data, int screenWidth) {
