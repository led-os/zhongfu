...
public class CommodityDecoration extends RecyclerView.ItemDecoration {
    ...
    public CommodityDecoration(int headerCount) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (layoutManager.getOrientation() == GridLayoutManager.VERTICAL) {
            ...
            if (childPosition % layoutManager.getSpanCount() == 0) {
                ...
                outRect.top = ScreenUtils.dip2px(SSDK.getInstance().getContext(), childPosition == 0 ? 16 : 5);
                outRect.right = ScreenUtils.dip2px(SSDK.getInstance().getContext(), 5);
                if (childPosition == totalCount - 1)
                    outRect.bottom = ScreenUtils.dip2px(SSDK.getInstance().getContext(), 20);
                else
                ...
                outRect.top = ScreenUtils.dip2px(SSDK.getInstance().getContext(), childPosition == 1 ? 16 : 5);
