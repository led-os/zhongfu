...
public class CustomToolbar extends Toolbar {
    ...
    private int mTitleTextColor = R.color.color_fff;
    ...
    private void resolveAttribute(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        context = getContext();
        @SuppressLint("RestrictedApi") final TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, android.support.v7.appcompat.R.styleable.Toolbar, defStyleAttr, 0);
        @SuppressLint("RestrictedApi") final int titleTextAppearance = a.getResourceId(android.support.v7.appcompat.R.styleable.Toolbar_titleTextAppearance, 0);
